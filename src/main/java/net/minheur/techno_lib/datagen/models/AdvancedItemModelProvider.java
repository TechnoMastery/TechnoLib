...
public abstract class AdvancedItemModelProvider extends ItemModelProvider {
    protected static LinkedHashMap<ResourceKey<TrimMaterial>, Float> trimMaterials = new LinkedHashMap<>();
    static {
    ...
    public AdvancedItemModelProvider(PackOutput output, String modid, ExistingFileHelper existingFileHelper) {
    ...
    private ItemModelBuilder runeItem(RegistryObject<Item> item) {
        return withExistingParent(item.getId().getPath(),
                new ResourceLocation("item/generated")).texture("layer0",
                new ResourceLocation(modid, "item/rune"));
    }

    private ItemModelBuilder circuitBoardItem(RegistryObject<Item> item) {
        return withExistingParent(item.getId().getPath(),
                new ResourceLocation("item/generated")).texture("layer0",
                new ResourceLocation(modid, "item/assisted_circuit_board"));
    }

    private ItemModelBuilder discItem(RegistryObject<Item> item) {
        return withExistingParent(item.getId().getPath(),
                new ResourceLocation("item/generated")).texture("layer0",
                new ResourceLocation(modid, "item/base_of_disc"));
    }
    ...
    public ItemModelBuilder quantumCoreItem(RegistryObject<Item> item) {
        return withExistingParent(item.getId().getPath(),
                new ResourceLocation("item/generated")).texture("layer0",
                new ResourceLocation(modid,"item/quantum_core"));
